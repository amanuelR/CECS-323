...
public class CarClub {
   ...
   public static void main(String[] args) {
      ...
      owners.add(new Owners("Diamond", "Shine", "534-972-3888"));
      owners.add(new Owners("Alexander", "West", "323-423-2877"));
      // Create the list of owners in the database.
      carclub.createEntity (owners);

      List <Cars> cars = new ArrayList<Cars>();
      //Cars(Owners owners, auto_body_styles autoBodyStyles,String VIN, String manufacturer, String model, int model_year)
      cars.add(new Cars(owners.get(0), carclub.getStyle("sedan"), "4X3BMHB68B3286050", "Toyota", "Corolla LE", 2015 ));
      cars.add(new Cars(owners.get(0), carclub.getStyle("convertible"), "6Y3XXXV68C4586050", "Ford", "Mustang GT", 2019 ));
      cars.add(new Cars(owners.get(1), carclub.getStyle("coupe"), "7X3HIKJ69A2286054", "Honda", "NSX", 2018 ));
      cars.add(new Cars(owners.get(1), carclub.getStyle("hatchback"), "6B3DDNNB68B329823", "Ford", "Fiesta SE", 2013 ));
      cars.add(new Cars(owners.get(2), carclub.getStyle("convertible"), "4X3BMHB68B3123122", "Toyota", "Camry Solara", 2010 ));
      cars.add(new Cars(owners.get(2), carclub.getStyle("minivan"), "9X3CCCC68B3289999", "Ford", "Mercury", 2007 ));
      cars.add(new Cars(owners.get(3), carclub.getStyle("coupe"), "0K3CCCB68B3000123", "Ferrari", "Roma", 2021 ));
      cars.add(new Cars(owners.get(3), carclub.getStyle("minivan"), "4X09HH68B32860507", "Toyota", "Sienna", 2021 ));
      cars.add(new Cars(owners.get(4), carclub.getStyle("coupe"), "7N3BDGF68B3286888", "Infiniti", "Q60", 2014 ));
      cars.add(new Cars(owners.get(4), carclub.getStyle("minivan"), "2G3NNHB68B3111111", "Nissan", "Quest", 2016 ));
